          ...
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                ...
                <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">  تغيير كلمة السر</h4>
              ...
              <div class="card-body">
                <form role="form" class="text-start" action="send-password-reset.php" method="post">
                  ...
                  <?php
    echo "<a href='mail.php?email=email'>
        <button type='submit' class='btn bg-gradient-primary w-100 my-4 mb-2' name='submit'>ارسال</button>
    </a>";
?>
